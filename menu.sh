...
echo -e "🔰${CYAN} NS Domain           👉 ${COLOR1}$( cat /etc/xray/dns )${NC}"
...
echo -e " $COLOR1│$NC    ${BICyan}[${WH}05${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}]$COLOR1 SS      ${NC}" "     ${BICyan}[${WH}10${BICyan}]${BICyan}[${BIYellow}Menu${BICyan}]$COLOR1 SET REBOOT  ${NC}" "${COLOR1}│${NC}"
echo -e " $COLOR1└─────────────────────────────────────────────────────┘${NC}" | lolcat
echo -e "$COLOR1 ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} ${NC}  ${BICyan}HARI ini${NC}: ${Blue}$ttoday$NC ${BICyan}KEMARIN${NC}: ${Blue}$tyest$NC ${BICyan}BULAN${NC}: ${Blue}$tmon$NC $NC"
echo -e "$COLOR1 └─────────────────────────────────────────────────────┘${NC}"
echo -e " $COLOR1┌─────────────────────────────────────────────────────┐${NC}" | lolcat
echo -e " $COLOR1│$NC  ${WH}Version      ${NC} :${BICyan} JB-01 LITE ${NC}"
