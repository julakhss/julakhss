...
clear;clear;clear
  ...
  # // Banner
echo -e "\033[33m☆ |====================================\e[0m"
echo -e "\033[33m☆ | Auto Script Installer Xray\e[0m"
echo -e "\033[33m☆ | Author: Julak Bantur\e[0m"
echo -e "\033[33m☆ | email: putrameratus2@gmail.com\e[0m"
echo -e "\033[33m☆ | telegram: t.me/Cibut2d\e[0m"
echo -e "\033[33m☆ |====================================\e[0m"
echo ""
sleep 5
###### IZIN SC
...
# Status ExpiRED Active | JULAK BANTUR Project
...
function base_package() {
    clear
    ########
    print_install "Install Packet Butuh"
...
clear
echo -e  "${BLUE}┌──────────────────────────────────────────┐${NC}"
echo -e  "${RED}|              MASUKKAN NAMA ANDA        |${NC}"
echo -e  "${BLUE}└──────────────────────────────────────────┘${NC}"
echo " "
...
bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install -u www-data --version $latest_version
    ...
    curl -s ipinfo.io/city >>/etc/xray/city
    curl -s ipinfo.io/org | cut -d " " -f 2-10 >>/etc/xray/isp
    print_install "Install Packet Config"
...
EOF
print_success "Packet Config"
}

function ssh(){
clear
print_install "Install Password"
...
function udp_mini(){
clear
print_install "Install Service Janda Pirang"
...
print_success "Service Janda Pirang"
}
...
# Ganti Banner
wget -O /etc/julak.txt "${REPO}ssh/issue.net"
...
function menu(){
    clear
    print_install "Install Paket 900"
...
print_success "Paket 900"
}

# Restart layanan after install
function enable_services(){
clear
print_install "Start All Service"
    systemctl daemon-reload
    systemctl start netfilter-persistent
    systemctl enable --now rc-local
    systemctl enable --now cron
    ...
    systemctl restart haproxy
    print_success "Start All Service"
    clear
}
...
sleep 3
wget -q https://raw.githubusercontent.com/ppnhss/vip/main/backup/tm.sh;chmod +x tm.sh;./tm.sh
