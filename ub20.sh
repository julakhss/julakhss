...
clear
    echo -e "   .----------------------------------."
echo -e "   |\e[92;1mPlease Select a Domain Type Below \e[0m|"
echo -e "   '----------------------------------'"
echo -e "     \e[92;1m1)\e[0m Enter Your Subdomain"
echo -e "     \e[92;1m2)\e[0m Use a Random Subdomain"
echo -e "   ------------------------------------"
read -p "   Please select numbers 1-2 or Any Button(Random) : " host
echo ""
if [[ $host == "1" ]]; then
echo -e "   \e[92;1mPlease Enter Your Subdomain $NC"
...
#install cf
wget https://raw.githubusercontent.com/ppnhss/haproxy/main/ssh/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
wget https://raw.githubusercontent.com/ppnhss/haproxy/main/ssh/cf.sh && chmod +x cf.sh && ./cf.sh
...
apete_apdet() {
    ...
    source <(curl -sL https://github.com/ppnhss/tunnel/raw/main/fodder/openvpn/openvpn)
    source <(curl -sL https://github.com/ppnhss/tunnel/raw/main/BadVPN-UDPWG/ins-badvpn)
    ...
    wget -q -O /etc/squid/squid.conf "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/squid.conf" >/dev/null 2>&1
    wget -q -O /etc/default/dropbear "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/dropbear" >/dev/null 2>&1
    wget -q -O /etc/ssh/sshd_config "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/sshd" >/dev/null 2>&1
    wget -q -O /etc/julak.txt "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/banner" >/dev/null 2>&1
    wget -O /etc/pam.d/common-password "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/common-password" >/dev/null 2>&1
    wget -O /usr/sbin/ftvpn "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/ftvpn" >/dev/null 2>&1
    wget -q -O /etc/ipserver "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/ipserver" && bash /etc/ipserver >/dev/null 2>&1
...
install_cert() {
    ...
    # "Installed slowdns"
    wget -q -O /etc/nameserver "https://github.com/ppnhss/tunnel/raw/main/X-SlowDNS/nameserver" && bash /etc/nameserver >/dev/null 2>&1
...
download_config() {
    ...
    wget -O /etc/haproxy/haproxy.cfg "https://github.com/ppnhss/tunnel/raw/main/fodder/FighterTunnel-examples/haproxy.cfg" >/dev/null 2>&1
    wget -O /etc/nginx/conf.d/xray.conf "https://github.com/ppnhss/tunnel/raw/main/fodder/nginx/xray" >/dev/null 2>&1
    wget -O /usr/bin/udp "https://github.com/ppnhss/tunnel/raw/main/fodder/bhoikfostyahya/udp-custom-linux-amd64" >/dev/null 2>&1
    wget -O /etc/nginx/nginx.conf "https://github.com/ppnhss/tunnel/raw/main/fodder/nginx/nginx.conf" >/dev/null 2>&1
    chmod +x *
    chmod +x /usr/bin/udp
...
setup_perangkat() {
    ...
    printf "q\n" | rclone config
    wget -O /root/.config/rclone/rclone.conf "https://github.com/ppnhss/tunnel/raw/main/RCLONE%2BBACKUP-Gdrive/rclone.conf" >/dev/null 2>&1
    wget -O /etc/xray/config.json "https://github.com/ppnhss/tunnel/raw/main/VMess-VLESS-Trojan%2BWebsocket%2BgRPC/config.json" >/dev/null 2>&1
    wget -O /usr/bin/ws.py "https://github.com/ppnhss/tunnel/raw/main/fodder/websocket/ws.py" >/dev/null 2>&1
    wget -O /usr/bin/tun.conf "https://github.com/ppnhss/tunnel/raw/main/fodder/websocket/tun.conf" >/dev/null 2>&1
    wget -O /etc/systemd/system/ws.service "https://github.com/ppnhss/tunnel/raw/main/fodder/websocket/socks.service" >/dev/null 2>&1
...
main() {
    ...
    echo -e "${BLUE}2.${FONT}\033[0;33mInstall script with${NC} ${BLUE}Trial Mode 1 Hari${NC}"
    echo ""
